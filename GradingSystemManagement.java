...
class Grading_System_Management {
    private int studentID;
    private String name;

    public Grading_System_Management(int studentID, String name) {
...
class GradingSystem {
    private Grading_System_Management[] students;
    ...
    public GradingSystem(int numStudents, int numGrades, int numCourses) {
        students = new Grading_System_Management[numStudents];
    ...
    public void addStudent(Grading_System_Management student) {
    ...
    public void Print_Grade_Report(int studentID) {
...
public class GradingSystemManagement {
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    Grading_System_Management student = new Grading_System_Management(id, name);
                ...
                case 4:
                    ...
                    stuid = input.nextInt();
                    gradingSystem.Print_Grade_Report(stuid);
                    break;
                case 5:
