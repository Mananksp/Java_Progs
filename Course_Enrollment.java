        ...
        do {
            ...
            switch (choice) {
                ...
                case 3:
                    System.out.print("Enter Student ID: ");
                    studentID = input.nextInt();
                    enrollment.Get_Enrollement_Courses(studentID, courses);
                    break;
                case 4:
